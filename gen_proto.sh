...
protoc \
	--gogofast_out=Mhdfs.proto=hadoop_hdfs,MSecurity.proto=../hadoop_common:${ROOT}/pb/hadoop_hdfs \
	-I${ROOT}/hadoop_protocols/common \
	-I${ROOT}/hadoop_protocols/hdfs \
	-I${ROOT}/hadoop_protocols ${ROOT}/hadoop_protocols/hdfs/*.proto

protoc \
	--gogofast_out=Mhdfs.proto=../hadoop_hdfs,Macl.proto=../hadoop_hdfs,Mxattr.proto=../hadoop_hdfs:${ROOT}/pb \
	-I${ROOT}/hadoop_protocols/common \
        -I${ROOT}/hadoop_protocols/hdfs \

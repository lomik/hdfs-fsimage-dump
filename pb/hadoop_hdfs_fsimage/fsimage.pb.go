...
import fmt "fmt"
import math "math"
import hadoop_hdfs "../hadoop_hdfs"
...
func (m *FileSummary) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OndiskVersion == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("ondiskVersion")
	} else {
		dAtA[i] = 0x8
		i++
...
func (m *INodeSection_XAttrCompactProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Name == nil {
		...
		dAtA[i] = 0xd
		i++
		i = encodeFixed32Fsimage(dAtA, i, uint32(*m.Name))
	}
	if m.Value != nil {
		dAtA[i] = 0x12
		i++
...
func (m *INodeSection_INodeFile) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Permission != nil {
		dAtA[i] = 0x29
		i++
		i = encodeFixed64Fsimage(dAtA, i, uint64(*m.Permission))
	}
	if len(m.Blocks) > 0 {
...
func (m *CacheManagerSection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NextDirectiveId == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("nextDirectiveId")
	} else {
		dAtA[i] = 0x8
		i++
	...
	if m.NumPools == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("numPools")
	} else {
		dAtA[i] = 0x10
		i++
	...
	if m.NumDirectives == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("numDirectives")
	} else {
		dAtA[i] = 0x18
		i++
...
func encodeFixed64Fsimage(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32Fsimage(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
func (m *FileSummary) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("ondiskVersion")
	}
...
func (m *CacheManagerSection) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("nextDirectiveId")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("numPools")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("numDirectives")
	}
...
var fileDescriptorFsimage = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xac, 0x58, 0xcd, 0x6f, 0x1c, 0x49,

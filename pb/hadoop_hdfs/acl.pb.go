...
func (m *AclEntryProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Scope == nil {
		return 0, proto.NewRequiredNotSetError("scope")
	} else {
		dAtA[i] = 0x10
		i++
	...
	if m.Permissions == nil {
		return 0, proto.NewRequiredNotSetError("permissions")
	} else {
		dAtA[i] = 0x18
		i++
...
func (m *AclStatusProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Sticky == nil {
		return 0, proto.NewRequiredNotSetError("sticky")
	} else {
		dAtA[i] = 0x18
		i++
		if *m.Sticky {
...
func (m *GetAclStatusResponseProto) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Result == nil {
		return 0, proto.NewRequiredNotSetError("result")
	} else {
		dAtA[i] = 0xa
		i++
...
func (m *AclEntryProto) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return proto.NewRequiredNotSetError("scope")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return proto.NewRequiredNotSetError("permissions")
	}
...
func (m *AclStatusProto) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return proto.NewRequiredNotSetError("sticky")
	}
...
func (m *GetAclStatusResponseProto) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return proto.NewRequiredNotSetError("result")
	}
